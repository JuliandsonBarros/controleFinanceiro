...
public class EmprestimoController {
	...
	public ResponseEntity<Void> insert(@RequestBody Emprestimo emprestimo) {
		Emprestimo emprestimoSalvo = service.insert(emprestimo);
	...
	public ResponseEntity<Void> update(@RequestBody Emprestimo emprestimo, @PathVariable Integer id){	
